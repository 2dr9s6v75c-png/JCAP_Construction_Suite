...
class QuotationView(ctk.CTkFrame):
    def __init__(self, parent, user, on_new_request=None):
    ...
    def build_ui(self):
        ...
        ctk.CTkLabel(
            panel,
            text=(
                "This module will manage project material requests, supplier quotation "
                "monitoring, attachments, status tracking, and multi-user record locking."
            ),
            font=("Segoe UI", 14),
            text_color="#607D8B",
            wraplength=700,
